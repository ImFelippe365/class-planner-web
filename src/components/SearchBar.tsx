		...
		<div>
			<form>   
				...
				<div className="relative">
						...
						<input type="search" className="block w-80 py-3 pl-10 pr-5 text-placeholder text-sm border-none rounded-lg bg-gray-50 focus:ring-primary focus:border-primary" placeholder={placeholder} required/>						
				</div>
			</form>
		</div>
	)
